...
export default function Bill() {
  ...
  const handleInVoice = async () => {
    let response = await axios.post("http://localhost:5000/api/add-arinvoice", {
      nameCus: nameCus,
      phone: phone,
      address: address,
      email: email,
  ...
  return (
    <div className="Bill">
          ...
          <Container className="d-grid" id="main-container">
            <Form className="text-left" id="sign-in-form">
              <div className="Bill-form-div">
                ...
                <FormGroup
                  controlId="sign-in-address form-control"
                  class="mb-3"
                >
                  <Form.Control
              ...
              <div className="Bill-form-div">
                ...
                <FormGroup
                  controlId="sign-in-email-address form-control"
                  class="mb-3"
                >
                  <Form.Control
                    type="email"
      ...
      <div>
        ...
        >
          <FcAdvertising style={{ marginBottom: "5.5px" }} />
          &nbsp;&nbsp;&nbsp;Ghi nợ
        </Button>
        <Button
          variant="primary"
        ...
        <span className="totalBill">
          {" "}
          {TotalBill === 1 ? "Tổng : Dữ liệu chưa có" : TotalBill}
        </span>
      </div>
    </div>
  );
